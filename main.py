...
def login():
    ...
    elif usernameEntry.get()=='Haris' and passwordEntry.get()=='HAris@123':
...
window.title('Welcome to Student Management System')

window.iconbitmap(
    r"C:\Users\haris\OneDrive\Desktop\sms source code\Webalys-Kameleon.pics-Student-3.512.ico"
)

window.resizable(True,True)

backgroundImage=ImageTk.PhotoImage(file=r'C:\Users\haris\OneDrive\Desktop\sms source code\bg.jpg')
